POD 'pod-fanwall' at iteration 2000
  ...
  Validation
    ...
    PASS  fan_capacity         the POD costs 30.0 Pa and the fan wall's datasheet offers 100 Pa at 5,000 m3/h (30%)
    PASS  settled              the places moved at most 0.00 K since the previous sample (settled below 0.25 K)
    PASS  ashrae_inlet         warmest rack inlet 20.6 degC -- within ASHRAE recommended (18.0-27.0 degC)
