 ...
 * away as CSV.
 *
 * Named for what it is rather than for what it is about: `racks.js` was this
 * file, and the page that configures the racks wanted that name too. One
 * overwrote the other, `results.js` could not import `RackInlets` any more,
 * and the whole results page stopped loading -- not the rack card, the page
 * (ADR-057).
 *
